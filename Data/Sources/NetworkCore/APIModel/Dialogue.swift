...
public struct APIRoom: Room {
    ...
    public var messages: [any Entities.RoomMessage]
    
    public init(id: Int64, namespace: String, oid: Int64, title: String, prompt: String, createdAt: Date, messages: [any Entities.RoomMessage]) {
        self.id = id
