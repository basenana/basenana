...
public struct APIWorkflowJob: WorkflowJob {
    ...
    public init(id: String, workflow: String, triggerReason: String, status: String, message: String, executor: String, queueName: String, jobTarget: Entities.WorkflowJobTarget, steps: [Entities.WorkflowJobStep], createdAt: Date, updatedAt: Date, startAt: Date, finishAt: Date) {
        self.id = id
