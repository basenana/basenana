...
// Source: Data/Sources/NetworkExtension/GRPC/fsapi-v1.proto
//
...
struct Api_V1_DocumentInfo: @unchecked Sendable {
  ...
  var searchContent: [String] {
    get {return _storage._searchContent}
    set {_uniqueStorage()._searchContent = newValue}
  }
...
extension Api_V1_WorkflowJobDetail.JobTarget: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 2: try { try decoder.decodeSingularInt64Field(value: &self.parentEntryID) }()
      case 3: try { try decoder.decodeRepeatedInt64Field(value: &self.entries) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.entries.isEmpty {
      try visitor.visitPackedInt64Field(value: self.entries, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Api_V1_DocumentInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    init(copying source: _StorageClass) {
      ...
      _searchContent = source._searchContent
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 11: try { try decoder.decodeRepeatedStringField(value: &_storage._searchContent) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._searchContent.isEmpty {
        try visitor.visitRepeatedStringField(value: _storage._searchContent, fieldNumber: 11)
      }
  ...
  static func ==(lhs: Api_V1_DocumentInfo, rhs: Api_V1_DocumentInfo) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._searchContent != rhs_storage._searchContent {return false}
