...
enum Api_V1_WebFileType: SwiftProtobuf.Enum, Swift.CaseIterable {
...
struct Api_V1_AccessTokenRequest: Sendable {
...
struct Api_V1_AccessTokenResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_QuickInboxRequest: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_QuickInboxResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_Pagination: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_GetGroupTreeRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_GetGroupTreeResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_FindEntryDetailRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_GetEntryDetailRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_GetEntryDetailResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_CreateEntryRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_CreateEntryResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_UpdateEntryRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_UpdateEntryResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_DeleteEntryRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_DeleteEntryResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_DeleteEntriesRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_DeleteEntriesResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_EntryFilter: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  enum GroupFilter: SwiftProtobuf.Enum, Swift.CaseIterable {
    typealias RawValue = Int
    case all // = 0
    case group // = 1
    case file // = 2
...
struct Api_V1_ListGroupChildrenRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  enum EntryOrder: SwiftProtobuf.Enum, Swift.CaseIterable {
    typealias RawValue = Int
    case name // = 0
    case kind // = 1
    case isGroup // = 2
...
struct Api_V1_ListGroupChildrenResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ChangeParentRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ChangeParentResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_WriteFileRequest: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_WriteFileResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ReadFileRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ReadFileResponse: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_Property: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_AddPropertyRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_AddPropertyResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_UpdatePropertyRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_UpdatePropertyResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_DeletePropertyRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_DeletePropertyResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_DocumentFilter: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ListDocumentsRequest: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  enum DocumentOrder: SwiftProtobuf.Enum, Swift.CaseIterable {
    typealias RawValue = Int
    case name // = 0
    case source // = 1
    case marked // = 2
...
struct Api_V1_GetDocumentParentsRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_GetDocumentParentsResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ListDocumentsResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_GetDocumentDetailRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_GetDocumentDetailResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_UpdateDocumentRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  enum DocumentMark: SwiftProtobuf.Enum, Swift.CaseIterable {
    typealias RawValue = Int
    case unchanged // = 0
    case marked // = 1
    case unmarked // = 2
...
struct Api_V1_UpdateDocumentResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_SearchDocumentsRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_SearchDocumentsResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_RoomInfo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_RoomMessage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ListRoomsRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ListRoomsResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_OpenRoomRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_OpenRoomResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_UpdateRoomRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_UpdateRoomResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_DeleteRoomRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ClearRoomRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_DeleteRoomResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ClearRoomResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ChatRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ChatResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ListMessagesRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ListMessagesResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var messages: [Api_V1_Message] = []
...
struct Api_V1_ReadMessagesRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ReadMessagesResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_GetLatestSequenceRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_GetLatestSequenceResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ListUnSyncedEventRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ListUnSyncedEventResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_CommitSyncedEventRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_CommitSyncedEventResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ListWorkflowsRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ListWorkflowsResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var workflows: [Api_V1_WorkflowInfo] = []
...
struct Api_V1_ListWorkflowJobsRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ListWorkflowJobsResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var jobs: [Api_V1_WorkflowJobDetail] = []
...
struct Api_V1_TriggerWorkflowRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  struct WorkflowTarget: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  struct WorkflowJobAttr: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
struct Api_V1_TriggerWorkflowResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_WorkflowInfo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var lastTriggeredAt: SwiftProtobuf.Google_Protobuf_Timestamp {
    get {return _lastTriggeredAt ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
    set {_lastTriggeredAt = newValue}
  }
  /// Returns true if `lastTriggeredAt` has been explicitly set.
  var hasLastTriggeredAt: Bool {return self._lastTriggeredAt != nil}
  /// Clears the value of `lastTriggeredAt`. Subsequent reads from it will return its default value.
  mutating func clearLastTriggeredAt() {self._lastTriggeredAt = nil}
  ...
  fileprivate var _lastTriggeredAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
}

struct Api_V1_WorkflowJobDetail: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var workflow: String {
    get {return _storage._workflow}
    set {_uniqueStorage()._workflow = newValue}
  }

  var triggerReason: String {
    get {return _storage._triggerReason}
    set {_uniqueStorage()._triggerReason = newValue}
  }
  ...
  var executor: String {
    get {return _storage._executor}
    set {_uniqueStorage()._executor = newValue}
  }

  var queueName: String {
    get {return _storage._queueName}
    set {_uniqueStorage()._queueName = newValue}
  }

  var target: Api_V1_WorkflowJobDetail.JobTarget {
    get {return _storage._target ?? Api_V1_WorkflowJobDetail.JobTarget()}
  ...
  var steps: [Api_V1_WorkflowJobDetail.JobStep] {
  ...
  var finishAt: SwiftProtobuf.Google_Protobuf_Timestamp {
    get {return _storage._finishAt ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
    set {_uniqueStorage()._finishAt = newValue}
  }
  /// Returns true if `finishAt` has been explicitly set.
  var hasFinishAt: Bool {return _storage._finishAt != nil}
  /// Clears the value of `finishAt`. Subsequent reads from it will return its default value.
  mutating func clearFinishAt() {_uniqueStorage()._finishAt = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  struct JobTarget: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
struct Api_V1_WorkflowPlugScope: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_DocumentInfo: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var subContent: String {
    get {return _storage._subContent}
    set {_uniqueStorage()._subContent = newValue}
  }

  var headerImage: String {
    get {return _storage._headerImage}
    set {_uniqueStorage()._headerImage = newValue}
  }
...
struct Api_V1_DocumentDescribe: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_EntryInfo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_EntryDetail: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_Message: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Api_V1_DeleteEntriesRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".DeleteEntriesRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "entryIDs"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedInt64Field(value: &self.entryIds) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.entryIds.isEmpty {
      try visitor.visitPackedInt64Field(value: self.entryIds, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Api_V1_DeleteEntriesRequest, rhs: Api_V1_DeleteEntriesRequest) -> Bool {
...
extension Api_V1_DeleteEntriesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".DeleteEntriesResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "entryIDs"),
  ]
  ...
  static func ==(lhs: Api_V1_DeleteEntriesResponse, rhs: Api_V1_DeleteEntriesResponse) -> Bool {
    if lhs.entryIds != rhs.entryIds {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Api_V1_ListMessagesRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Api_V1_ListMessagesRequest, rhs: Api_V1_ListMessagesRequest) -> Bool {
...
extension Api_V1_ListMessagesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Api_V1_ListMessagesResponse, rhs: Api_V1_ListMessagesResponse) -> Bool {
    if lhs.messages != rhs.messages {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Api_V1_ReadMessagesRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ReadMessagesRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "messageIDList"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedStringField(value: &self.messageIdlist) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.messageIdlist.isEmpty {
      try visitor.visitRepeatedStringField(value: self.messageIdlist, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Api_V1_ReadMessagesRequest, rhs: Api_V1_ReadMessagesRequest) -> Bool {
    if lhs.messageIdlist != rhs.messageIdlist {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Api_V1_ReadMessagesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ReadMessagesResponse"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Api_V1_ReadMessagesResponse, rhs: Api_V1_ReadMessagesResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Api_V1_ListWorkflowsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ListWorkflowsRequest"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Api_V1_ListWorkflowsRequest, rhs: Api_V1_ListWorkflowsRequest) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Api_V1_ListWorkflowsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ListWorkflowsResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Api_V1_ListWorkflowsResponse, rhs: Api_V1_ListWorkflowsResponse) -> Bool {
...
extension Api_V1_ListWorkflowJobsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ListWorkflowJobsRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Api_V1_ListWorkflowJobsRequest, rhs: Api_V1_ListWorkflowJobsRequest) -> Bool {
...
extension Api_V1_ListWorkflowJobsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ListWorkflowJobsResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "jobs"),
  ]
  ...
  static func ==(lhs: Api_V1_ListWorkflowJobsResponse, rhs: Api_V1_ListWorkflowJobsResponse) -> Bool {
...
extension Api_V1_WorkflowInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".WorkflowInfo"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "name"),
    3: .same(proto: "executor"),
    4: .same(proto: "queueName"),
    5: .same(proto: "healthScore"),
    10: .same(proto: "createdAt"),
    11: .same(proto: "updatedAt"),
    12: .same(proto: "lastTriggeredAt"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularStringField(value: &self.name) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self.executor) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self.queueName) }()
      case 5: try { try decoder.decodeSingularInt32Field(value: &self.healthScore) }()
      case 10: try { try decoder.decodeSingularMessageField(value: &self._createdAt) }()
      case 11: try { try decoder.decodeSingularMessageField(value: &self._updatedAt) }()
      case 12: try { try decoder.decodeSingularMessageField(value: &self._lastTriggeredAt) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.executor.isEmpty {
      try visitor.visitSingularStringField(value: self.executor, fieldNumber: 3)
    }
    if !self.queueName.isEmpty {
      try visitor.visitSingularStringField(value: self.queueName, fieldNumber: 4)
    }
    if self.healthScore != 0 {
      try visitor.visitSingularInt32Field(value: self.healthScore, fieldNumber: 5)
    }
    try { if let v = self._createdAt {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 10)
    } }()
  ...
  static func ==(lhs: Api_V1_WorkflowInfo, rhs: Api_V1_WorkflowInfo) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.name != rhs.name {return false}
...
extension Api_V1_WorkflowJobDetail: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".WorkflowJobDetail"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "workflow"),
    3: .same(proto: "triggerReason"),
    4: .same(proto: "status"),
    5: .same(proto: "message"),
    6: .same(proto: "executor"),
    7: .same(proto: "queueName"),
    8: .same(proto: "target"),
    9: .same(proto: "steps"),
    10: .same(proto: "createdAt"),
    11: .same(proto: "updatedAt"),
    12: .same(proto: "startAt"),
    13: .same(proto: "finishAt"),
  ]

  fileprivate class _StorageClass {
    var _id: String = String()
    var _workflow: String = String()
    var _triggerReason: String = String()
    var _status: String = String()
    var _message: String = String()
    var _executor: String = String()
    var _queueName: String = String()
    var _target: Api_V1_WorkflowJobDetail.JobTarget? = nil
    var _steps: [Api_V1_WorkflowJobDetail.JobStep] = []
    var _createdAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _updatedAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _startAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _finishAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try { try decoder.decodeSingularStringField(value: &_storage._workflow) }()
        case 3: try { try decoder.decodeSingularStringField(value: &_storage._triggerReason) }()
        ...
        case 6: try { try decoder.decodeSingularStringField(value: &_storage._executor) }()
        case 7: try { try decoder.decodeSingularStringField(value: &_storage._queueName) }()
        case 8: try { try decoder.decodeSingularMessageField(value: &_storage._target) }()
        case 9: try { try decoder.decodeRepeatedMessageField(value: &_storage._steps) }()
        ...
        case 12: try { try decoder.decodeSingularMessageField(value: &_storage._startAt) }()
        case 13: try { try decoder.decodeSingularMessageField(value: &_storage._finishAt) }()
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._workflow.isEmpty {
        try visitor.visitSingularStringField(value: _storage._workflow, fieldNumber: 2)
      }
      if !_storage._triggerReason.isEmpty {
        try visitor.visitSingularStringField(value: _storage._triggerReason, fieldNumber: 3)
      }
      ...
      if !_storage._executor.isEmpty {
        try visitor.visitSingularStringField(value: _storage._executor, fieldNumber: 6)
      }
      if !_storage._queueName.isEmpty {
        try visitor.visitSingularStringField(value: _storage._queueName, fieldNumber: 7)
      }
      try { if let v = _storage._target {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 8)
      } }()
      if !_storage._steps.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._steps, fieldNumber: 9)
      }
      ...
      try { if let v = _storage._finishAt {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 13)
      } }()
    }
    try unknownFields.traverse(visitor: &visitor)
  ...
  static func ==(lhs: Api_V1_WorkflowJobDetail, rhs: Api_V1_WorkflowJobDetail) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        ...
        if _storage._triggerReason != rhs_storage._triggerReason {return false}
        if _storage._status != rhs_storage._status {return false}
        if _storage._message != rhs_storage._message {return false}
        if _storage._executor != rhs_storage._executor {return false}
        if _storage._queueName != rhs_storage._queueName {return false}
        ...
        if _storage._finishAt != rhs_storage._finishAt {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Api_V1_WorkflowJobDetail.JobTarget: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Api_V1_WorkflowJobDetail.protoMessageName + ".JobTarget"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "entryID"),
    2: .same(proto: "parentEntryID"),
  ]
  ...
  static func ==(lhs: Api_V1_WorkflowJobDetail.JobTarget, rhs: Api_V1_WorkflowJobDetail.JobTarget) -> Bool {
    if lhs.entryID != rhs.entryID {return false}
    if lhs.parentEntryID != rhs.parentEntryID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Api_V1_WorkflowJobDetail.JobStep: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Api_V1_WorkflowJobDetail.protoMessageName + ".JobStep"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
    2: .same(proto: "status"),
  ...
  static func ==(lhs: Api_V1_WorkflowJobDetail.JobStep, rhs: Api_V1_WorkflowJobDetail.JobStep) -> Bool {
    if lhs.name != rhs.name {return false}
...
extension Api_V1_WorkflowPlugScope: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".WorkflowPlugScope"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "pluginName"),
    2: .same(proto: "version"),
    3: .same(proto: "pluginType"),
    4: .same(proto: "action"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularStringField(value: &self.pluginType) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.pluginType.isEmpty {
      try visitor.visitSingularStringField(value: self.pluginType, fieldNumber: 3)
    }
  ...
  static func ==(lhs: Api_V1_WorkflowPlugScope, rhs: Api_V1_WorkflowPlugScope) -> Bool {
...
extension Api_V1_DocumentInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _subContent: String = String()
    var _headerImage: String = String()
    var _properties: [Api_V1_Property] = []
    ...
    init(copying source: _StorageClass) {
      ...
      _subContent = source._subContent
      _headerImage = source._headerImage
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 9: try { try decoder.decodeSingularStringField(value: &_storage._subContent) }()
        case 10: try { try decoder.decodeSingularStringField(value: &_storage._headerImage) }()
        case 20: try { try decoder.decodeRepeatedMessageField(value: &_storage._properties) }()
        case 21: try { try decoder.decodeSingularMessageField(value: &_storage._parent) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._subContent.isEmpty {
        try visitor.visitSingularStringField(value: _storage._subContent, fieldNumber: 9)
      }
      if !_storage._headerImage.isEmpty {
        try visitor.visitSingularStringField(value: _storage._headerImage, fieldNumber: 10)
      }
      if !_storage._properties.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._properties, fieldNumber: 20)
      }
  ...
  static func ==(lhs: Api_V1_DocumentInfo, rhs: Api_V1_DocumentInfo) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._subContent != rhs_storage._subContent {return false}
        if _storage._headerImage != rhs_storage._headerImage {return false}
...
extension Api_V1_DocumentDescribe: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 13: try { try decoder.decodeSingularStringField(value: &_storage._headerImage) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._headerImage.isEmpty {
        try visitor.visitSingularStringField(value: _storage._headerImage, fieldNumber: 13)
      }
...
extension Api_V1_Message: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 6: try { try decoder.decodeSingularStringField(value: &self.action) }()
      case 7: try { try decoder.decodeSingularStringField(value: &self.status) }()
      case 10: try { try decoder.decodeSingularMessageField(value: &self._time) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.action.isEmpty {
      try visitor.visitSingularStringField(value: self.action, fieldNumber: 6)
    }
    if !self.status.isEmpty {
  ...
  static func ==(lhs: Api_V1_Message, rhs: Api_V1_Message) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.title != rhs.title {return false}
    if lhs.message != rhs.message {return false}
    if lhs.type != rhs.type {return false}
