...
struct Api_V1_DeleteEntriesRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_DeleteEntriesResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ListMessagesRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ListMessagesResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ReadMessagesRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ReadMessagesResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ListWorkflowsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ListWorkflowsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ListWorkflowJobsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_ListWorkflowJobsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_WorkflowJobDetail {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Api_V1_WorkflowPlugScope {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Api_V1_DeleteEntriesRequest: @unchecked Sendable {}
extension Api_V1_DeleteEntriesResponse: @unchecked Sendable {}
...
extension Api_V1_ListMessagesRequest: @unchecked Sendable {}
extension Api_V1_ListMessagesResponse: @unchecked Sendable {}
extension Api_V1_ReadMessagesRequest: @unchecked Sendable {}
extension Api_V1_ReadMessagesResponse: @unchecked Sendable {}
...
extension Api_V1_ListWorkflowsRequest: @unchecked Sendable {}
extension Api_V1_ListWorkflowsResponse: @unchecked Sendable {}
extension Api_V1_ListWorkflowJobsRequest: @unchecked Sendable {}
extension Api_V1_ListWorkflowJobsResponse: @unchecked Sendable {}
...
extension Api_V1_WorkflowInfo: @unchecked Sendable {}
extension Api_V1_WorkflowJobDetail: @unchecked Sendable {}
extension Api_V1_WorkflowJobDetail.JobTarget: @unchecked Sendable {}
extension Api_V1_WorkflowJobDetail.JobStep: @unchecked Sendable {}
extension Api_V1_WorkflowPlugScope: @unchecked Sendable {}
...
extension Api_V1_Message: @unchecked Sendable {}
