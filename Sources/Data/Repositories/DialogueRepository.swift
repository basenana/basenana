...
public class DialogueRepository: DialogueRepositoryProtocol {
    ...
    public func ListRoomes(entry: Int64) async throws -> [any Room] {
        return try await core.ListRoomes(entry: entry)
    }
    
    public func OpenRoom(entry: Int64, room: Int64, option: RoomOption) async throws -> any Room {
    ...
    public func ChatInRoom(room: Int64, message: String, handler: @escaping (RoomMessage, Bool) async -> Void) async throws {
